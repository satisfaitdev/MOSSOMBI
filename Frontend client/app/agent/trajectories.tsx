...
export default function TrajectoriesScreen() {
  ...
  return (
    <GradientBackground style={{ flex: 1 }} opacity="10">
      ...
      <View style={{
        ...
        <AdaptiveText variant="body" weight="bold" style={{ fontSize: 18, flex: 1 }}>Trajectoires</AdaptiveText>
      </View>

      <ScrollView contentContainerStyle={{ padding: SPACING.lg, gap: SPACING.lg }}>
        <LiquidGlassCard padding={SPACING.md}>
          <AdaptiveText variant="caption" style={{ color: colors.textSecondary }}>
            À brancher: trajectoires / bus pour {String(serviceId || '')}.
          </AdaptiveText>
        </LiquidGlassCard>
      </ScrollView>
    </GradientBackground>
